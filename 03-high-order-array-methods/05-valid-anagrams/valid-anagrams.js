...
function validAnagrams(str1, str2) {
  ...
  // then reduce each array into an object of character frequencies for the first string
  ...
  // Split the strings into arrays of characters, 
  // then reduce each array into an object of character frequencies for the second string
  ...
  const areValidAnagrams = Object.keys(freqCount1).every(
    (char) => freqCount1[char] === freqCount2[char],
  );

  console.log(areValidAnagrams);
}
